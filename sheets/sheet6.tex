...
\textbf{Problem 5(a)} Compute the LU factorisation of the following transposed Vandermonde matrices:
\[
\begin{bmatrix}
1 & 1 \\
x_1 & x_2
...
\textbf{Problem 5(b)} Show that the determinant of a Vandermonde matrix is
\[
\det V = \ensuremath{\prod}_{k=1}^n \ensuremath{\prod}_{j=k+1}^n (x_j - x_j).
\]
