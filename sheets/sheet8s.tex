...
= {\exp(4{\rm i} \ensuremath{\theta}) -4\exp(2{\rm i} \ensuremath{\theta}) +6 -4 \exp(-2{\rm i} \ensuremath{\theta})+\exp(-2{\rm i} \ensuremath{\theta}) \over 16}
}
...
\ensuremath{\bm{\e}}_k^\ensuremath{\top} C_n C_n^\ensuremath{\top} \ensuremath{\bm{\e}}_\ensuremath{\ell}  = \pr({\begin{cases} 1 & k = \ensuremath{\ell} = 1 \\ \sqrt{2} & k,\ensuremath{\ell} = 1, k \ensuremath{\neq} \ensuremath{\ell} \\
     ...
     {1 \over n} \ensuremath{\sum}_{j=1}^n \cos((k-1)\ensuremath{\theta}_{j-1}) \cos((\ensuremath{\ell}-1)\ensuremath{\theta}_{j-1}) \ccr
