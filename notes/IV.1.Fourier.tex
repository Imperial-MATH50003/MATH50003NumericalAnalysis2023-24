...
\begin{definition}[Trapezium Rule] Let $\ensuremath{\theta}_j = 2\ensuremath{\pi}j/n$ for $j = 0,1,\ensuremath{\ldots},n$ denote $n+1$ evenly spaced points over $[0,2\ensuremath{\pi}]$. The \emph{Trapezium rule} over $[0,2\ensuremath{\pi}]$ is the approximation:
\[
