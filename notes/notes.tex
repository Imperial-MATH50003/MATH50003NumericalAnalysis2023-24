...
\begin{enumerate}
    ...
    \item IV.3 Orthogonal Polynomials: For non-periodic functions we consider using orthogonal polynomials, and discuss basic properties.
    \item IV.4 Classical Orthogonal Polynomials: For certain weights, orthogonal polynomials are classical and have addition structure.
