...
We work with approximating functions by expansions in
...
\begin{enumerate}
\item IV.1 Fourier Expansions:
\item IV.2 Discrete Fourier Transform:
\item IV.3 Orthogonal Polynomials:
\item IV.4 Classical Orthogonal Polynomials:
\item IV.5 Gaussian Quadrature:
\end{enumerate}
