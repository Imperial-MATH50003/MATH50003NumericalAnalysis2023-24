...
\item III.4 Polynomial Regression: often if statistics one needs to approximate data by a polynomial.
We discuss how to reduce this to solving a rectangular least squares problem.
